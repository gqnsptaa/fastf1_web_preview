...
def quali():
    ...
    for drv in drivers:
        drvs_fastest_lap = sess.laps.pick_drivers(drv).pick_fastest()
    ...
    for index, lap in fastest_laps.iterlaps():
        color = fastf1.plotting.get_team_color(lap['Team'], session=sess)
    ...
    plt.suptitle(f"{sess.event['EventName']} {session.event.year} Qualifying\n"
